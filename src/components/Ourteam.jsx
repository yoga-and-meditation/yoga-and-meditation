...
const Ourteam = () => {
    const cardsData = [
        { id: 1, title: 'Abdulwase Naeemi',Linkedin:'https://www.linkedin.com/in/abdulwase-naeemi/',Github:'https://github.com/Naeemi7',image:image2 },
  ...
  return (
    ...
    {cardsData.map((card) => (
      <div key={card.id} className="card">
        ...
        <h4>{card.title}</h4>
        <div className='icon-container'>  <a href={card.Linkedin} target="_blank" rel="noopener noreferrer">
